function plothisf_unlinkability(client,imposter,flag,bitlength,maxscore,maxsum)
...
plot(X_vect,Y1,'r-',X_vect,Y2,'b-.','LineWidth',3.5);

xlabel('Normalized Matching Scores', 'FontSize', 15)
ylabel('Frequency', 'FontSize', 15)
title('Mated-Imposter & Non-Mated-Imposter: LFW10', 'FontSize', 15)

set(gcf,'color',[1 1 1])
lgd = legend(strcat('Mated-Imposter (mean: ',num2str(mean1),' | ','var: ',...
    num2str(var1),')'),strcat('Non-Mated-Imposter (mean: ',num2str(mean2),' | ','var: ',num2str(var2),')'));
lgd.FontSize = 11;
